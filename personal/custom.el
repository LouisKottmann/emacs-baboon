(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ace-jump-buffer ace-jump-mode ace-window ag ansible-doc anzu auto-highlight-symbol browse-kill-ring calfw change-inner coffee-mode company-anaconda company-inf-ruby company-quickhelp company-shell diff-hl discover-my-major dockerfile-mode easy-kill elisp-slime-nav erc-image ewmctrl fancy-narrow flx-ido flycheck ggtags gist git-timemachine gitconfig-mode gitignore-mode google-translate grizzl guide-key guru-mode hackernews haml-mode helm-ag hideshowvis highlight-numbers ido-grid-mode ido-ubiquitous jinja2-mode js2-mode json-mode key-chord magit markdown-mode move-text moz multiple-cursors neotree operate-on-number pkgbuild-mode powerline projectile-rails rainbow-delimiters rainbow-mode rbenv robe ruby-tools scss-mode slime-company smartparens smartrep smartscan smex smooth-scrolling solarized-theme soundcloud ssh-config-mode systemd tabbar twittering-mode undo-tree visual-regexp vline volatile-highlights w3 web-mode yaml-mode yari zygospore erc-colorize)))
